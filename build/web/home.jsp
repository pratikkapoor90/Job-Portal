...
<ul id="circularMenu">
    ...
    <td width="650" height="500" bgcolor="black" valign="top">
      <p>
<br />
<br />


    <font size="4" face="Baskerville Old Face" color="white">  Job Portals are the most popular and widely used tool by companies and recruitment teams to facilitate the smooth flow of recruitment process in the competitive world. Job Portals provide a platform for the employers to meet the prospective employees. The job aspirants can register in job Portals by creating a user ID. Job Portals allow users to submit and edit their resumes and apply for specific jobs at companies of their choice. The companies have the choice to search for their ideal candidate from the resume database using various options and parameters available in the job Portals. The portal supports the employer from listing of jobs to selecting an ideal candidate.
<br /><br />There are mainly two end users in a Job Portal:-
<br /><br />A. <font color="maroon"><u><b>Job Aspirant</b></u></font>: will be allowed to register on a Job Portal site and post resume.

<br /><br />B. <font color="maroon"><u><b>Employee</b></u></font>:
<br />1)  will manage job postings(advertising for the available jobs and searching for resumes).
<br />2)  will check all the resumes and short list the deserving candidates after analysing their resumes.
<br /><br />

The employers can get quick returns for their investment as the portal incorporates a simple and quick recruitment method.
</font>
<br /></p>
        </td>
  ...
  <td width="350" height="500">
      <br /><br />
       <p align="center"><img src="home_pic.jpg"></p>
...
<table border="0" width="1250" height="80" bgcolor="#2D4F98">
