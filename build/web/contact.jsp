<%--
    Document   : about
    Created on : 19 Jul, 2011, 8:07:10 AM
...
jQuery(function($){ //on document.ready
	...
	$('a.addspeech').speechbubble({url:'empregis1.txt'})
})
 ...
 <body bgcolor="#000000">
     ...
     <form name="registrationForm" action="empregis1" method="POST" enctype="multipart/form-data">
...
<td width="1238" height="248">
 <p align="left"><img src="contact.jpg" align="top"></p>
 </td>
</table>
</div>
...
<li><a rel="ddsubmenu1">Login</a></li>
<li><a rel="ddsubmenu2">Services</a></li>
...
<td width="320" height="500" valign="center">
...
#circularMenu {padding:0; margin:0 auto; list-style:none; position:relative; width:200px; height:300px; background:#000000 no-repeat;}
...
<font size="4" face="Andalus" color="blue"><u>Head/ Work Office</u></font><br /><br />
<font size="4" face="Californian FB" color="#98989A">

FirstSalary.com
AMITY UNIVERSITY, NOIDA-201 303
UTTAR PRADESH
Phone: 0120-2445252<br /><br /><br /><br />
</font>




<font size="4" face="Andalus" color="blue"><u>Branch Offices</u></font><br /><br />

<font size="4" face="Californian FB" color="#98989A">
1.   FirstSalary.com<br />
     1171,KAMLA NAGAR,NORTH CAMPUS
     DELHI-110007
     Phone: 9711245198,9999705976<br />

2.   FirstSalary.com<br />
     12/1,SHAKTI NAGAR
     DELHI-110007
     Phone: 9810864892
</font>
...
<td width="500" height="500">
 <p align="center"><img src="contact1.jpg"></p>
</td>
</table>
</div>
     </form>
