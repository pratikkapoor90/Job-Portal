...
var pw1 = document.registrationForm.password.value;
if (pw1 == '' ) {
...
<body>
 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
     <form action="seekerlogin" name="registrationForm" method="post" >

<div align="left">

<font size="6.5" face="Book Antiqua" color="#317DA5"><b>&nbsp;Job Seeker Login</b></font>
...
<td width="350" height="450" align="left"><img src="loginimag.png" alt="face" width="250" height="250" /><br /><br /><br /><br />
   <a href="seekerregis1.jsp"><img src="img2.bmp" alt="face" width="200" height="100" /></a> </td>

<td width="550" height="450">
<p><font size="5" face="Californian FB" color="#98989A"><b>&nbsp;E-mail Id      :</b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="text" name="email" size="23" onblur="javascript : return emaill()"></p>
          <font color="white"><div id="emailErr"></div></font>
          <p><font size="5" face="Californian FB" color="#98989A"><b>&nbsp;Password      :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          </b></font><input type="password" name="password" size="23" align="right" onkeyup="checkCapsWarning(event)" onfocus="checkCapsWarning(event)" onblur="removeCapsWarning()"/>
          <font color="white"> <div id="pasErr"></div></font>
           <div style="display:none;color:silver" id="capsIndicator"><img src="warning.png" width="23" height="23"/> Caps Lock is on!</div>

</p>
          <br />
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="submit" value="Submit" name="submit" onclick="javascript : return main()"></p>
