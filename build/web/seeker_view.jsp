...
<td width="1000" height="500">
     <p align="center"><font size="6" color="#090557"> Job Seeker Information </font></p>
...
PreparedStatement pst=conn.prepareStatement("Select * from seekerregis1 where id='"+temp2+"' ");
...
PreparedStatement ps=conn.prepareStatement("Select * from seekerregis2 where id='"+temp2+"' ");
...
<br /> <br />
  ...
  &nbsp; &nbsp;&nbsp;<font size="4" face="Californian FB" color="#98989A">Email Id :&nbsp;&nbsp;&nbsp;</font><font size="4" face="Californian FB" color="#F7EDF8"><%=rs.getString("email")%></font>   <br /><br />
  <input type="hidden" name="pass1" value="<%=rs.getString("pass1")%>" /> 
   
  &nbsp; &nbsp;&nbsp;<font size="4" face="Californian FB" color="#98989A">Qualification :&nbsp;&nbsp;&nbsp;</font><font size="4" face="Californian FB" color="#F7EDF8"><%=rs.getString("qualification")%></font>  <br /><br />
  &nbsp; &nbsp;&nbsp;<font size="4" face="Californian FB" color="#98989A">Experience:</font>
    &nbsp; &nbsp;&nbsp;<font size="4" face="Californian FB" color="#98989A">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Year :&nbsp;&nbsp;&nbsp;</font><font size="4" face="Californian FB" color="#F7EDF8"><%=rs.getString("expyear")%></font>    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;        <font size="4" face="Californian FB" color="#98989A">Month :&nbsp;&nbsp;&nbsp;</font><font size="4" face="Californian FB" color="#F7EDF8"><%=rs.getString("expmonth")%> </font>  <br /><br />
   &nbsp; &nbsp;&nbsp;<font size="4" face="Californian FB" color="#98989A">Key Skills :&nbsp;&nbsp;&nbsp;</font><font size="4" face="Californian FB" color="#F7EDF8"><%=rs.getString("skills")%></font>
...
&nbsp; &nbsp;&nbsp;<font size="4" face="Californian FB" color="#98989A">First Name :&nbsp;&nbsp;&nbsp;</font><font size="4" face="Californian FB" color="#F7EDF8"><%=rst.getString("fname")%></font>  <br /><br />
  &nbsp; &nbsp;&nbsp;<font size="4" face="Californian FB" color="#98989A">Last name :&nbsp;&nbsp;&nbsp;</font><font size="4" face="Californian FB" color="#F7EDF8"><%=rst.getString("lname")%></font>   <br /><br />
  &nbsp; &nbsp;&nbsp;<font size="4" face="Californian FB" color="#98989A">Date :&nbsp;&nbsp;&nbsp;</font><font size="4" face="Californian FB" color="#F7EDF8"><%=rst.getString("ddate")%></font>  <br /><br />
  &nbsp; &nbsp;&nbsp;<font size="4" face="Californian FB" color="#98989A">Month :&nbsp;&nbsp;&nbsp;</font><font size="4" face="Californian FB" color="#F7EDF8"><%=rst.getString("mmonth")%></font>  <br /><br />
  &nbsp; &nbsp;&nbsp;<font size="4" face="Californian FB" color="#98989A">Year :&nbsp;&nbsp;&nbsp;</font><font size="4" face="Californian FB" color="#F7EDF8"><%=rst.getString("yyear")%></font>  <br /><br />
   &nbsp; &nbsp;&nbsp;<font size="4" face="Californian FB" color="#98989A">Gender :&nbsp;&nbsp;&nbsp;</font><font size="4" face="Californian FB" color="#F7EDF8"><%=rst.getString("gender")%></font>  <br /><br />
  &nbsp; &nbsp;&nbsp;<font size="4" face="Californian FB" color="#98989A">Address :&nbsp;&nbsp;&nbsp;</font><font size="4" face="Californian FB" color="#F7EDF8"><%=rst.getString("address")%></font>   <br /><br />
  &nbsp; &nbsp;&nbsp;<font size="4" face="Californian FB" color="#98989A">Pincode :&nbsp;&nbsp;&nbsp;</font><font size="4" face="Californian FB" color="#F7EDF8"><%=rst.getString("pincode")%></font>  <br /><br />
   &nbsp; &nbsp;&nbsp;<font size="4" face="Californian FB" color="#98989A">Mobile :&nbsp;&nbsp;&nbsp;</font><font size="4" face="Californian FB" color="#F7EDF8"><%=rst.getString("mobile")%> </font> <br /><br />
